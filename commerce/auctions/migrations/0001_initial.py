    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('start_time', models.DateTimeField(default=datetime.datetime(2022, 2, 6, 2, 13, 4, 122486, tzinfo=utc), editable=False)),
                ('end_time', models.DateTimeField(default=datetime.datetime(2022, 2, 13, 2, 13, 4, 122486, tzinfo=utc))),
